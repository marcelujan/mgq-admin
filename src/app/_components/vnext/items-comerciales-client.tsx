            ...
            {sortedRows.map((r) => (
              <tr key={r.item_comercial_id} style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                <td style={{ padding: "5px 10px", lineHeight: 1.15, whiteSpace: "nowrap" }}>
                  <span title={r.estado_detalle || r.estado} style={{ display: "inline-flex", width: 10, height: 10, borderRadius: 999, background: estadoColor(r.estado), boxShadow: `0 0 0 1px ${estadoColor(r.estado)}66 inset` }} />
                </td>
