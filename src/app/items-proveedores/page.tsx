    ...
    <div style={{ padding: 16, display: "grid", gap: 16 }}>
      <div style={{ display: "grid", gap: 4 }}>
        ...
        <div style={{ fontSize: 12, opacity: 0.7 }}>
          Alta por URLs + monitoreo de runs del cron diario. El detalle histórico de precios vive en Items (gráficos).
        </div>
      </div>

      <div style={{ border: "1px solid rgba(255,255,255,0.10)", borderRadius: 14, padding: 14, background: "rgba(255,255,255,0.02)" }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, margin: 0, marginBottom: 10 }}>Cargar URLs</h2>
        <ItemsNewClient forcedTab="PROVEEDOR" hideTabs backHref="/items-proveedores" />
      </div>

      <div style={{ border: "1px solid rgba(255,255,255,0.10)", borderRadius: 14, padding: 14, background: "rgba(255,255,255,0.02)" }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, margin: 0, marginBottom: 10 }}>Jobs diario</h2>
        <JobsDiarioClient hideHeader />
      </div>

      <div style={{ border: "1px solid rgba(255,255,255,0.10)", borderRadius: 14, padding: 14, background: "rgba(255,255,255,0.02)" }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, margin: 0, marginBottom: 10 }}>Listado (Proveedor)</h2>
