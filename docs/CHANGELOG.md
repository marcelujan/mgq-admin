...
- Código/UI: agregada hoja de inicio con accesos a las nuevas rutas vNext en el mismo orden del header.
- Código/UI: el header mantiene el indicador DB a la derecha usando scroll horizontal para la banda de navegación.
- Código/API: agregado `/api/origenes-tecnicos` para seleccionar FKs válidas desde formularios vNext.
- Código/UI: los formularios vNext dejan de pedir IDs manuales de origen técnico y pasan a seleccionar desde listas buscables.
- Código/UI: se retira la casilla visible `Activo` de las hojas nuevas en este corte.
