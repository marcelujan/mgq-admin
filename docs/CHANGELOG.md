- Stock: se agrega eliminar operación desde la tabla de Operaciones recientes y se aclara que esa tabla muestra solo un tramo reciente, no el historial completo.
